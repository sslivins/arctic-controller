...
// Read the live value of advanced parameter AP `ap`.
// Returns true on success and stores the signed value in *value_out.
...
// Attempt to write `value` to advanced parameter AP `ap`.
