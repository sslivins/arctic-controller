...
static const char* strings_en[STR_COUNT] = {
    ...
    [STR_DISPLAY_OFF_AFTER_DIM] = "Turn off after dimming",
    [STR_DISPLAY_IDLE_DESCRIPTION] = "The turn-off timer starts after dimming. The first tap wakes the screen without activating a control.",
...
static const char* strings_fr[STR_COUNT] = {
    ...
    [STR_DISPLAY_OFF_AFTER_DIM] = "Éteindre après l'atténuation",
    [STR_DISPLAY_IDLE_DESCRIPTION] = "Le délai d'arrêt commence après l'atténuation. Le premier toucher réveille l'écran sans activer de commande.",
...
static const char* strings_es[STR_COUNT] = {
    ...
    [STR_DISPLAY_OFF_AFTER_DIM] = "Apagar después de atenuar",
    [STR_DISPLAY_IDLE_DESCRIPTION] = "El temporizador de apagado comienza después de atenuar. El primer toque activa la pantalla sin accionar ningún control.",
