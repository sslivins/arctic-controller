...
static const char* strings_en[STR_COUNT] = {
    ...
    [STR_TIME_24H_FORMAT] = "24-Hour Time",
    ...
    [STR_SETTINGS_TIME] = "Time & Location",
    [STR_LOCATION_TITLE] = "Location",
    [STR_LOCATION_CHANGE] = "Change",
    [STR_LOCATION_NONE] = "Not set",
    [STR_LOCATION_SEARCH_HINT] = "Type a city name (3+ letters)",
    [STR_LOCATION_SEARCHING] = "Searching...",
    [STR_LOCATION_SEARCH_FAILED] = "Search failed. Check network.",
    [STR_LOCATION_NO_MATCHES] = "No matches found",
    [STR_LOCATION_SELECT] = "Select a location",
    [STR_TIME_TZ_AUTOMATIC] = "Set automatically from location",
    [STR_TIME_TZ_UNMAPPED] = "(unmapped - set manually)",
    ...
    [STR_HA_PAIRING_DESCRIPTION] = "Start pairing, then enter the code in Home Assistant to connect.",
    ...
    [STR_HA_REPAIR] = "Re-pair",
    [STR_HA_PAIRED_DESCRIPTION] = "Paired with Home Assistant. Re-pair to connect a different Home Assistant.",
    ...
    [STR_SECURITY_NOT_SECURED_DESC] = "This controller still uses its factory password. Open its web interface, then enter the one-time code shown here to set your own password.",
    [STR_SECURITY_SECURED_DESC] = "A custom administrator password is set. Show a one-time code if you need to change the password, or to recover it after a lockout using Forgot password in the web interface.",
    [STR_SECURITY_SHOW_CODE] = "Show One-Time Code",
    [STR_SECURITY_HIDE_CODE] = "Hide One-Time Code",
    [STR_SECURITY_CODE_LABEL] = "One-time code",
    ...
    [STR_HISTORY_OPEN] = "Cycle History",
    [STR_HISTORY_TITLE] = "Cycle History",
    [STR_HISTORY_PREVIOUS] = "Previous 8h",
    [STR_HISTORY_NEXT] = "Next 8h",
    [STR_HISTORY_LATEST] = "Latest",
    [STR_HISTORY_BACK] = "Back",
    [STR_HISTORY_INLET] = "Inlet",
    [STR_HISTORY_OUTLET] = "Outlet",
    [STR_HISTORY_SETPOINT] = "Setpoint",
    ...
    [STR_HISTORY_STORAGE_ERROR] = "Unable to read temperature history",
...
static const char* strings_fr[STR_COUNT] = {
    ...
    [STR_TIME_FORMAT_12H] = "12h",
    [STR_TIME_FORMAT_24H] = "24h",
    [STR_TIME_24H_FORMAT] = "Format 24 heures",
    ...
    [STR_SETTINGS_TIME] = "Heure et lieu",
    [STR_LOCATION_TITLE] = "Lieu",
    [STR_LOCATION_CHANGE] = "Modifier",
    [STR_LOCATION_NONE] = "Non défini",
    [STR_LOCATION_SEARCH_HINT] = "Nom de ville (3+ lettres)",
    [STR_LOCATION_SEARCHING] = "Recherche...",
    [STR_LOCATION_SEARCH_FAILED] = "Échec. Vérifiez le réseau.",
    [STR_LOCATION_NO_MATCHES] = "Aucun résultat",
    [STR_LOCATION_SELECT] = "Sélectionnez un lieu",
    [STR_TIME_TZ_AUTOMATIC] = "Définir selon le lieu",
    [STR_TIME_TZ_UNMAPPED] = "(non mappé - manuel)",
    ...
    [STR_HA_PAIRING_DESCRIPTION] = "Démarrez l'association, puis saisissez le code dans Home Assistant pour vous connecter.",
    ...
    [STR_HA_REPAIR] = "Ré-associer",
    [STR_HA_PAIRED_DESCRIPTION] = "Associé à Home Assistant. Ré-associez pour connecter un autre Home Assistant.",
    ...
    [STR_SECURITY_NOT_SECURED_DESC] = "Ce contrôleur utilise encore son mot de passe d'usine. Ouvrez son interface web, puis saisissez le code à usage unique affiché ici pour définir votre propre mot de passe.",
    [STR_SECURITY_SECURED_DESC] = "Un mot de passe administrateur personnalisé est défini. Affichez un code à usage unique pour modifier le mot de passe, ou pour le récupérer via Mot de passe oublié dans l'interface web.",
    [STR_SECURITY_SHOW_CODE] = "Afficher le code à usage unique",
    [STR_SECURITY_HIDE_CODE] = "Masquer le code à usage unique",
    [STR_SECURITY_CODE_LABEL] = "Code à usage unique",
    ...
    [STR_HISTORY_OPEN] = "Historique des cycles",
    [STR_HISTORY_TITLE] = "Historique des cycles",
    [STR_HISTORY_PREVIOUS] = "8 h précédentes",
    [STR_HISTORY_NEXT] = "8 h suivantes",
    [STR_HISTORY_LATEST] = "Récent",
    [STR_HISTORY_BACK] = "Retour",
    [STR_HISTORY_INLET] = "Entrée",
    [STR_HISTORY_OUTLET] = "Sortie",
    [STR_HISTORY_SETPOINT] = "Consigne",
    ...
    [STR_HISTORY_STORAGE_ERROR] = "Impossible de lire l'historique",
...
static const char* strings_es[STR_COUNT] = {
    ...
    [STR_TIME_FORMAT_12H] = "12h",
    [STR_TIME_FORMAT_24H] = "24h",
    [STR_TIME_24H_FORMAT] = "Formato 24 horas",
    ...
    [STR_SETTINGS_TIME] = "Hora y ubicación",
    [STR_LOCATION_TITLE] = "Ubicación",
    [STR_LOCATION_CHANGE] = "Cambiar",
    [STR_LOCATION_NONE] = "Sin definir",
    [STR_LOCATION_SEARCH_HINT] = "Nombre de ciudad (3+ letras)",
    [STR_LOCATION_SEARCHING] = "Buscando...",
    [STR_LOCATION_SEARCH_FAILED] = "Error. Revise la red.",
    [STR_LOCATION_NO_MATCHES] = "Sin resultados",
    [STR_LOCATION_SELECT] = "Seleccione una ubicación",
    [STR_TIME_TZ_AUTOMATIC] = "Establecer según ubicación",
    [STR_TIME_TZ_UNMAPPED] = "(sin mapear - manual)",
    ...
    [STR_HA_PAIRING_DESCRIPTION] = "Inicia el emparejamiento y luego introduce el código en Home Assistant para conectar.",
    ...
    [STR_HA_REPAIR] = "Volver a emparejar",
    [STR_HA_PAIRED_DESCRIPTION] = "Emparejado con Home Assistant. Vuelve a emparejar para conectar otro Home Assistant.",
    ...
    [STR_SECURITY_NOT_SECURED_DESC] = "Este controlador aún usa su contraseña de fábrica. Abre su interfaz web y luego introduce el código de un solo uso que se muestra aquí para establecer tu propia contraseña.",
    [STR_SECURITY_SECURED_DESC] = "Hay una contraseña de administrador personalizada. Muestra un código de un solo uso para cambiar la contraseña o recuperarla con ¿Olvidaste la contraseña? en la interfaz web.",
    [STR_SECURITY_SHOW_CODE] = "Mostrar código de un solo uso",
    [STR_SECURITY_HIDE_CODE] = "Ocultar código de un solo uso",
    [STR_SECURITY_CODE_LABEL] = "Código de un solo uso",
    ...
    [STR_HISTORY_OPEN] = "Historial de ciclos",
    [STR_HISTORY_TITLE] = "Historial de ciclos",
    [STR_HISTORY_PREVIOUS] = "8 h anteriores",
    [STR_HISTORY_NEXT] = "8 h siguientes",
    [STR_HISTORY_LATEST] = "Actual",
    [STR_HISTORY_BACK] = "Atrás",
    [STR_HISTORY_INLET] = "Entrada",
    [STR_HISTORY_OUTLET] = "Salida",
    [STR_HISTORY_SETPOINT] = "Consigna",
    ...
    [STR_HISTORY_STORAGE_ERROR] = "No se puede leer el historial",
