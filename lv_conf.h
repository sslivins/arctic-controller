...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    /* NOTE: In ESP-IDF, this is overridden by CONFIG_LV_MEM_SIZE_KILOBYTES in sdkconfig */
...
#define LV_ASSERT_HANDLER abort();   /*Panic and reboot instead of wedging a task*/
